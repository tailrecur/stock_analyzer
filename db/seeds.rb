...
Formula.create!(:value => "company.sales_growth_rate > sector.expenses_growth_rate")
Formula.create!(:value => "company.balance_sheet.debt_to_capital_ratio < 20")
Formula.create!(:value => "company.closing_price <= 0.67 * company.ncavps")
...
Formula.create!(:value => "company.balance_sheet.debt_to_assets_ratio > 50", :weight => -1)
